...
parser.add_argument('--save-dir', default='/home/ungraduate/hjj/BMI_DETECT/NewExperiment/Models/test', type=str,
...
def main():
    ...
    #Pred_dict = torch.load('Models/SEDensenet121_3CWithMask_128_tran/model_epoch_50.ckpt')['state_dict']
    ...
    trainer.load('Models/SEDensenet121_3CWithMask_128_tran/model_epoch_50.ckpt')
